...
(function() {
        ...
        if (a && b && c) {
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                for (var g = a.replace(/^data:[a-z/]*;base64,/, ""),
                        ...
                        p = new Uint8Array(k), h = 0; h < g.length; h++) p[h] = g.charCodeAt(h);
                b = new Blob([k], {
                    type: "image/" + b
                });
                try {
    ...
    function v(a, b, c) {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this._container.innerHTML = "",
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas),
                ...
                E(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart",
                    function(a) {
                ...
                E(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend",
                    function(a) {
                        d._touchEventHandler(a)
                    }),
                E(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel",
                    function(a) {
                        d._touchEventHandler(a)
                    }),
                ...
                this._toolTip = new N(this,
                    this._options.toolTip,
                    this.theme),
                this.layoutManager = new aa(this),
    ...
    var t = !!document.createElement("canvas").getContext,
        ...
        V = {
            colorSet1: "#6DBCEB #F48D39".split(" "),
            colorSet2: "#6CD3C6 #91acd6 #CCCDCF #F48D39".split(" "),
            colorSet3: "".split("#6CD3C6 #91acd6 #CCCDCF #F48D39 #6CD3C6")
        },
        W = {
            theme1: {
                Chart: {
    ...
    v.prototype._updateOptions = function() {
        ...
        if ("undefined" === typeof ha.Chart.creditHref) this.creditHref = "", this.creditText = "";
